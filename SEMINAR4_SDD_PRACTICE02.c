...
//}
//
////Realizati o functie care afiseaza doar filmele (=> VOI FOLOSI FUNCTIA DE AFISARE A UNEI STRUCTURI FILM, VOI APELA 
...
//
//
////stergeti toate filmele care au un anumit gen(primit ca parametru).
////
////tratati cazul în care elementele sunt la începutul listei
////tratati cazul în care sunt în mijloc sau la final
////pot exista mai multe filme de sters
